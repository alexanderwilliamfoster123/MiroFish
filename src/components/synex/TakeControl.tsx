...
const ACTIVITIES = [
  ...
  },
  {
    ...
    title: "AI FATE recomnendation applied",
  ...
  return (
    ...
    >
      <div className="max-w-[1432px] mx-auto px-6 md:px-10 pt-24 pb-12 flex flex-col items-center">
        ...
        >
          Synex brings together your assets, data, and execution into one
