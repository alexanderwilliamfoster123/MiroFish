  ...
  return (
    <main className="relative min-h-dvh w-full">
      ...
      {room === "contact" && (
        <section
          key="contact"
          className="animate-fade-in flex min-h-dvh flex-col items-center justify-center gap-7 overflow-hidden px-4 pt-10 pb-32"
        >
          {/* the email window — safari chrome, monochrome */}
          <div
            className="animate-fade-up w-[min(680px,94vw)] overflow-hidden rounded-xl border border-white/10 bg-[#0b0b0b] shadow-[0_40px_120px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.05)]"
            style={{ animationDelay: "0.1s" }}
          >
            <div className="flex items-center justify-between border-b border-white/[0.07] bg-white/[0.03] px-4 py-2.5">
              ...
              <div className="mx-4 flex h-5 max-w-md flex-1 items-center justify-center rounded-md bg-white/[0.05]">
            ...
            {contactSent ? (
              ...
              <>
                <div className="border-b border-white/[0.06] px-4 py-2 text-[12px] text-neutral-500">
                  to: <span className="text-neutral-300">alex@vertus.ai</span>
                </div>
                <div className="border-b border-white/[0.06] px-4 py-2 text-[12px] text-neutral-500">
                  subject:{" "}
                ...
                <div className="min-h-[260px] px-4 py-3 text-[13px] leading-relaxed whitespace-pre-wrap text-neutral-200">
                  {message}
                  <span className="animate-cursor-blink ml-px inline-block h-[13px] w-[1.5px] translate-y-[2px] bg-neutral-200" />
                </div>
              </>
            )}
          </div>

          <div className="animate-fade-up" style={{ animationDelay: "0.25s", zoom: 1.3 }}>
