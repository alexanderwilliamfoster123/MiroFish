...
const FAQS = [
  {
    ...
    a: "You subscribe once, connect the brokerage you already use — Public.com, Alpaca, or Interactive Brokers — and choose your strategies. Every trade executes directly in your own account and you can watch each position in real time. There is nothing to transfer and no new account to fund.",
  },
  {
